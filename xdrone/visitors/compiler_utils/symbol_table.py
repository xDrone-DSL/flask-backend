...
class Variable:
    def __init__(self, type: Type, value: Union[int, float, str, bool, list]):
        self._type = type
        self._value = value
    ...
    def __str__(self):
        return "Variable: {{ type: {}, value: {} }}".format(self._type, self._value)

    def __eq__(self, other):
        if isinstance(other, Variable):
            return other._type == self._type and other._value == self._value
        return False
...
class SymbolTable:
    ...
    def update(self, ident: str, value: Union[int, float, str, bool, list]) -> None:
        ...
        self._symbol_table[ident] = Variable(old_variable.type, value)
